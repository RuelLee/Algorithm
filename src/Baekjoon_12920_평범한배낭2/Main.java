...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        // 1 + 2 + 4 + 8 = 15로 총 4개의 비트 필드를 만든다. 그리고 나머지에 대해서는 그냥 하나의 수를
        // 위 경우에서는 1, 2, 4, 8, 12로 채워진다.
        // 1 ~ 15까지의 수는 1, 2, 4, 8의 수들로 모두 만들 수 있다. 2진법과 같으므로.
        // 16 ~ 27까지의 수는 추가적으로 있는 12와 1 ~ 8까지의 수들을 적절히 조합하여 얻어낼 수 있다.
        // 27이 27번의 연산이 아닌 5개의 연산으로 줄었다.
